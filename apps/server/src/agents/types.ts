...
export interface SessionState extends Dict {
  ...
  performance_optimizations?: Dict;
  design_system?: Dict;
  accessibility_audit?: Dict;
  prompt_library?: Dict;
  guardrails_config?: Dict;
  knowledge_base?: Dict;
  content_dedup_report?: Dict;
  retrieval_metrics?: Dict;
  rag_config?: Dict;
  cicd_pipeline?: Dict;
  infrastructure_config?: Dict;
  observability_setup?: Dict;
  alert_catalog?: Dict;
  test_suites?: Dict;
  ...
  openapi_spec?: Dict;
  release_plan?: Dict;
  feature_flag_matrix?: Dict;
  privacy_assessment?: Dict;
  data_classification?: Dict;
  i18n_plan?: Dict;
  translation_assets?: Dict;
  documentation_bundle?: Dict;
  example_library?: Dict;
